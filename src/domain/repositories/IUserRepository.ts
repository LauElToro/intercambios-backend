...
export interface IUserRepository {
  ...
  linkGoogleAccount(userId: number, googleId: string, fotoPerfil?: string): Promise<void>;
  findAll(): Promise<User[]>;
  save(user: User, password?: string, options?: { googleId?: string; fotoPerfil?: string }): Promise<User>;
